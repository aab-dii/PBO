                    ...
                    while (pilih != 1 && pilih!=2) {//perulangan konfirmasi pengubahan data
                        ...
                        switch (pilih) {//statement switch berdasarkan variabel pilih
                            case 1://pilihan ya
                                ...
                                dataultramans.get(ubah-1).nama = namabr;
                                dataultramans.get(ubah-1).umur = umurbr;
                                dataultramans.get(ubah-1).tinggi = tinggibr;                    
                                dataultramans.get(ubah-1).berat = beratbr;
                                dataultramans.get(ubah-1).kecepatan = kecepatanbr;
                                dataultramans.get(ubah-1).human_host = humanbr;                    
                                dataultramans.get(ubah-1).kousen = kousenbr;                    
                                dataultramans.get(ubah-1).era = erabr;
